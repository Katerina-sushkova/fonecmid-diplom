...
Функция СозданиеРеализаций(ДанныеСтруктуры, МассивДанных) Экспорт
    ...
    Данные = ДанныеСтруктуры.ДанныеОбъекта;
    ЕстьРеализации = ПроверитьРеализациюНаПериод(Данные[0].Период);
   ...
   КонецЕсли; 
    ...
    Если Данные[1].Количество() > 0 Тогда
 
        Для Каждого Строка Из Данные[1] Цикл
		...
		ПоместитьВоВременноеХранилище(МассивВозврат);	
